...
public class ImprovedNegotiator extends Thread {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				ImprovedNegotiator negotiator = new ImprovedNegotiator(name, serverAddress, SERVER_PORT);
	...
	public void negotiate() {
		...
		System.out.println("CmImprovedNegotiator.negotiate() " + this.myName + " waiting for start message.");
		Serializable[] domainInfo = (Serializable[]) this.negoClient.waitTillReady();
		System.out.println("CmImprovedNegotiator.negotiate() " + this.myName + " Has received start message.");
